...
fate-hevc-bsf-dovi-split-bl-rpu: CMD = framecrc -i $(TARGET_SAMPLES)/mkv/dovi-p7-hvce.mkv -c:v copy -bsf:v dovi_split=mode=bl+rpu
...
fate-hevc-bsf-dovi-split-el-rpu: CMD = framecrc -i $(TARGET_SAMPLES)/mkv/dovi-p7-hvce.mkv -c:v copy -bsf:v dovi_split=mode=el+rpu
